...
def set_piece_position():
    """
    Draw the chess pieces in their initial positions
    :return: nothing
    """
    # the black pawns /////////////
    black_pawn1.draw_piece()
    display.blit(black_pawn1.draw_piece(),
                 (black_pawn1.set_coordinates(black_pawn1_x, black_pawn1_y)))  # first black pawn
    ...
    display.blit(black_horse_left.draw_piece(),
                 (black_horse_left.set_coordinates(black_horse_left_x, black_horse_left_y)))
    black_horse_right.draw_piece()
    display.blit(black_horse_right.draw_piece(),
                 (black_horse_right.set_coordinates(black_horse_right_x, black_horse_right_y)))

    # Black Bishops //////////////////////////
    black_bishop_left.draw_piece()
    display.blit(black_bishop_left.draw_piece(),
                 (black_bishop_left.set_coordinates(black_bishop_left_x, black_bishop_left_y)))
    black_bishop_right.draw_piece()
    display.blit(black_bishop_right.draw_piece(),
                 (black_bishop_right.set_coordinates(black_bishop_right_x, black_bishop_right_y)))
    ...
    black_bishop_right.draw_piece()
    display.blit(black_rook_right.draw_piece(),
                 (black_rook_right.set_coordinates(black_rook_right_x, black_rook_right_y)))
    ...
    display.blit(white_pawn1.draw_piece(),
                 (white_pawn1.set_coordinates(white_pawn1_x, white_pawn1_y)))  # first white pawn
    ...
    display.blit(white_horse_left.draw_piece(),
                 (white_horse_left.set_coordinates(white_horse_left_x, white_horse_left_y)))
    black_horse_right.draw_piece()
    display.blit(white_horse_right.draw_piece(),
                 (white_horse_right.set_coordinates(white_horse_right_x, white_horse_right_y)))

    # the white bishops///////////////////////
    white_bishop_left.draw_piece()
    display.blit(white_bishop_left.draw_piece(),
                 (white_bishop_left.set_coordinates(white_bishop_left_x, white_bishop_left_y)))
    black_bishop_right.draw_piece()
    display.blit(white_bishop_right.draw_piece(),
                 (white_bishop_right.set_coordinates(white_bishop_right_x, white_bishop_right_y)))
    ...
    display.blit(white_rook_right.draw_piece(),
                 (white_rook_right.set_coordinates(white_rook_right_x, white_rook_right_y)))
...
def move_piece(x, y, id):
    ...
    :param id: the id of the moving piece
    :return: null
    """
    # for pawns
    if id == "bp1":
